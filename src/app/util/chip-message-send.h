...
/**
 * @file
 *   This file declares a function that can be called to send a message (in the
 *   form of a buffer and length). The type (unicast or broadcast) and
 *   destination of the message is decided by the global variable
 *   appTransaction
 */
