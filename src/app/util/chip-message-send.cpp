...
EmberStatus chipSendUnicast(ExchangeContext & exchangeContext, EmberApsFrame * apsFrame, uint16_t messageLength, uint8_t * message)
{
    ...
    CHIP_ERROR err = exchangeContext.SendMessage(Protocols::kProtocol_InteractionModel, 0, buffer.Release_ForNow());
